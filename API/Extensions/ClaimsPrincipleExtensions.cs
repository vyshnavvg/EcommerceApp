...
public static class ClaimsPrincipleExtensions
{
    ...
    //Extends the ClaimsPricipal to add new method GetEmail. property after this keyword is what we are extending of
    public static string GetEmail(this ClaimsPrincipal user)
    {
        var email = user.FindFirstValue(ClaimTypes.Email) 
            ?? throw new AuthenticationException("Email claim not found");
        // if(email == null) throw new AuthenticationException("Email claim not found"); same above line
        return email;
    }
}
